...
%!test % 3d
%! T = randn(2,3,4)*1i+randn(2,3,4);
%! A{1} = rand(2,3)*1i+randn(2,3);
%! A{2} = rand(3,4)*1i+randn(3,4);
%! A{3} = rand(4,5)*1i+randn(4,5);
%! out = cttucker(T,A);
...
%! assert(out,ref,1e-13)
%!test % tensorization
%! A{1} = randn(1,2)*1i+randn(1,2);
%! A{2} = randn(1,3)*1i+randn(1,3);
%! A{3} = randn(1,4)*1i+randn(1,4);
%! A{4} = randn(1,5)*1i+randn(1,5);
%! out = cttucker(1,A);
...
%! T =randn(2,3,4,5)*1i+randn(2,3,4,5);
%! A1 = randn(2,3)*1i+randn(2,3);
%! A2 = randn(3,4)*1i+randn(3,4);
%! A3 = randn(4,5)*1i+randn(4,5);
%! A4 = randn(5,6)*1i+randn(5,6);
